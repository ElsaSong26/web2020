  ...
  <div class="open">
    <div class="sales-board">
      ...
      <div class="sales-board-form">
        ...
        <div class="sales-board-line-right"><Counter :counterObj="counterObj"/></div>
      </div>
      <div class="sales-board-form">
        <div class="sales-board-line-left">产品类型:</div>
        <div class="sales-board-line-right"><Types :selecterData="selecterData" /></div>
      </div>
      <div class="sales-board-form">
        <div class="sales-board-line-left">有效时间:</div>
        <div class="sales-board-line-right"><Timer  :timerData="timerData"/></div>
      </div>
    </div>
...
import Types from '../../../../components/HomePage/types.vue';
export default {
  components: { 
    Counter,
    Types,
