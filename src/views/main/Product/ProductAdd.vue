    ...
    @before-close="handleClose">
        ...
        >
            <el-form-item label="商品类目">
                <el-button class="location" type="primary" @click="dialogCategoryHandle">类目选择</el-button>
            ...
            <el-form-item label="商品描述">
                <ProductWang @onEditor="getEditor"/>
            </el-form-item>
        </el-form>
        <span slot="footer" class="dialog-footer">
...
<script>
import ProductBaiduUE from './ProductBaiduUE.vue';
import ProductTree from './ProductTree.vue';
import ProductUpload from './ProductUpload.vue';
import ProductWang from './ProductWang.vue';
export default {
  components: { 
      ProductTree,
    ProductUpload,
